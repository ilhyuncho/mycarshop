...
import com.carshop.mycarshop.domain.buyingCar.QBuyingCar;
...
//    @Override
//    public Optional<BuyingCar> findHighProposalPriceInfo(Long sellingCarId) {
//
//        QBuyingCar buyingCar = QBuyingCar.buyingCar;
//
//        JPQLQuery<BuyingCar> query = from(buyingCar);
...
//
//        return Optional.of(resultBuyingCar);
//    }
